...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { descricao: @sala.descricao, escola_id: @sala.escola_id, periodo_id: @sala.periodo_id, professor_id: @sala.professor_id } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { descricao: @sala.descricao, escola_id: @sala.escola_id, periodo_id: @sala.periodo_id, professor_id: @sala.professor_id } }
