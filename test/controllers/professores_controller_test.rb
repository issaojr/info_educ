...
class ProfessoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professores_url, params: { professor: { categoria: @professor.categoria, nome: @professor.nome, nota_prova: @professor.nota_prova, pontuacao: @professor.pontuacao, registro: @professor.registro } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { categoria: @professor.categoria, nome: @professor.nome, nota_prova: @professor.nota_prova, pontuacao: @professor.pontuacao, registro: @professor.registro } }
